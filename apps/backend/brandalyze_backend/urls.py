...
from brands.views import BrandViewSet, BrandSampleViewSet, upload_file, analyze_text, analyze_brand_alignment
...
urlpatterns = [
    ...
    path('api/analyze/brand-alignment', analyze_brand_alignment, name='analyze_brand_alignment')
]
