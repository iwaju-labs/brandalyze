### Metrics to track
these are the metrics I want to track in the analysis portion (putting them here so I can add as I think of things)

- percentage of tweets in each category (graphed)
