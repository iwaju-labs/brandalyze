        ...
        headers: [
          {
            ...
            value: [
              ...
              "font-src 'self' data:",
              "connect-src 'self' https://*.clerk.accounts.dev https://clerk.brandalyze.io https://clerk-telemetry.com https://tally.so wss://*.clerk.accounts.dev wss://clerk.brandalyze.io https://cloud.umami.is https://api-gateway.umami.dev",
